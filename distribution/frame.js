...
/******/ 	return __webpack_require__(__webpack_require__.s = "./source/frame.js");
/******/ })
/************************************************************************/
/******/ ({
...
var Overlay = function () {
  ...
  (0, _createClass3.default)(Overlay, [{
    key: 'highlight',
    value: function highlight(node, ts, scrollOnHighlight) {
      if (scrollOnHighlight) {
        node.scrollIntoViewIfNeeded();
      }
      var box = node.getBoundingClientRect();
      (0, _assign2.default)(this.container.style, {
        left: box.left + 'px',
        top: box.top + 'px',
        width: box.width + 'px',
      ...
      if (!ts) {
        (0, _assign2.default)(this.tip.style, {
          display: 'none'
        });
      } else {
        (0, _assign2.default)(this.tip.style, {
...
function findElementsByTagName(currWindow, tag) {
  var els = currWindow.document.getElementsByTagName(tag);
  var elsArray = Array.prototype.slice.call(els);
  for (var i = 0; i < currWindow.frames.length; i++) {
    try {
      var frameElsArray = findElementsByTagName(currWindow.frames[i].window, tag);
...
function getSources() {
  ...
  overlay = null;
  // images
  var prefix = window.location.origin + '/static/';
  var srcList = [];
  var imgs = findElementsByTagName(window, 'img');
  for (var i = 0, len = imgs.length; i < len; i++) {
    // exclude WBM /static/images, leaked images and embedded data URIs
    if (!imgs[i].src || imgs[i].src.startsWith(prefix) || !imgs[i].src.startsWith(window.location.origin) || imgs[i].src.startsWith('data:')) {
      continue;
    }
  ...
  // frames
  var frames = findElementsByTagName(window, 'frame');
  for (var _i = 0, _len = frames.length; _i < _len; _i++) {
    if (!frames[_i].src) {
      continue;
    }
    srcList.push(frames[_i].src);
  }

  var iframes = findElementsByTagName(window, 'iframe');
  for (var _i2 = 0, _len2 = iframes.length; _i2 < _len2; _i2++) {
    if (!iframes[_i2].src || iframes[_i2].id && iframes[_i2].id === 'playback') {
      continue;
    }
    srcList.push(iframes[_i2].src);
  }

  var scripts = findElementsByTagName(window, 'script');
  for (var _i3 = 0, _len3 = scripts.length; _i3 < _len3; _i3++) {
    if (!scripts[_i3].src || scripts[_i3].src.startsWith(prefix) || !scripts[_i3].src.startsWith(window.location.origin)) {
      continue;
    }
    srcList.push(scripts[_i3].src);
  }

  // link.href (CSS, RSS, etc)
  var links = findElementsByTagName(window, 'link');
  for (var _i4 = 0, _len4 = links.length; _i4 < _len4; _i4++) {
    if (!links[_i4].href || links[_i4].href.startsWith(prefix) || !links[_i4].href.startsWith(window.location.origin)) {
      continue;
    }
    if (links[_i4].rel && links[_i4].rel == 'stylesheet') {
      srcList.push(links[_i4].href);
    }
  }
  // deduplicate
...
var messageHandler = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(request, _, sendResponse) {
    var node;
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            if (!(request.message === 'highlightNode')) {
              _context.next = 16;
              break;
            }

            console.log(request.data.source);
            node = imageMap[request.data.source];
          ...
          case 16:
            if (request.message === 'removeHighlight' || request.message === 'drawerClosed') {
              if (overlay) {
                overlay.remove();
                overlay = null;
              }
  ...
  return function messageHandler(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

var VALID_TAGS = ['DIV', 'ARTICLE', 'SECTION', 'A', 'P', 'H1', 'H2', 'H3', 'H4', 'H5', 'H6', 'BLOCKQUOTE', 'PRE', 'TD', 'TH', 'DL', 'IMG'];
...
(function () {
  ...
  reactHotLoader.register(Overlay, 'Overlay', '/Users/viven/Opensource/vandal/source/frame.js');
  reactHotLoader.register(findElementsByTagName, 'findElementsByTagName', '/Users/viven/Opensource/vandal/source/frame.js');
  reactHotLoader.register(imageMap, 'imageMap', '/Users/viven/Opensource/vandal/source/frame.js');
  reactHotLoader.register(overlay, 'overlay', '/Users/viven/Opensource/vandal/source/frame.js');
  reactHotLoader.register(getSources, 'getSources', '/Users/viven/Opensource/vandal/source/frame.js');
  reactHotLoader.register(mousedownHandler, 'mousedownHandler', '/Users/viven/Opensource/vandal/source/frame.js');
  reactHotLoader.register(messageHandler, 'messageHandler', '/Users/viven/Opensource/vandal/source/frame.js');
  reactHotLoader.register(VALID_TAGS, 'VALID_TAGS', '/Users/viven/Opensource/vandal/source/frame.js');
  reactHotLoader.register(onDomReady, 'onDomReady', '/Users/viven/Opensource/vandal/source/frame.js');
  leaveModule(module);
})();
