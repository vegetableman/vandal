...
/******/ 	return __webpack_require__(__webpack_require__.s = "./source/bustalert.js");
/******/ })
/************************************************************************/
/******/ ({
...
var _domLoaded = __webpack_require__(/*! dom-loaded */ "./node_modules/dom-loaded/index.js");
...
var BustAlert = function () {
  function BustAlert() {
    var _this = this;

    (0, _classCallCheck3.default)(this, BustAlert);

    this.handleClose = function () {
      _this.container.classList.remove('vandal-alert__fade-done');
      _this.root.parentNode.removeChild(_this.root);
      _this.root = null;
      _this.container = null;
    };

    this.root = document.createElement('vandal-alert');
    var shadowRoot = this.root.attachShadow({ mode: 'open' });
    ...
    setTimeout(function () {
      _this.container.classList.add('vandal-alert__fade-done');
    }, 500);
  }

  (0, _createClass3.default)(BustAlert, [{
    key: 'getArchiveURL',
    value: function getArchiveURL() {
      var currentURL = new URL(location.href);
      if (currentURL.host === 'web.archive.org') {
        return location.href.replace('im_', '');
      } else {
        return 'https://web.archive.org/web/*/' + location.href.replace(/[\?|\&]?tag=vandal/, '');
      }
    }
  }, {
    key: 'getCloseIcon',
...
(function () {
  ...
  reactHotLoader.register(tmpl, 'tmpl', '/Users/viven/Opensource/vandal/source/bustalert.js');
  reactHotLoader.register(BustAlert, 'BustAlert', '/Users/viven/Opensource/vandal/source/bustalert.js');
  reactHotLoader.register(init, 'init', '/Users/viven/Opensource/vandal/source/bustalert.js');
  leaveModule(module);
})();
