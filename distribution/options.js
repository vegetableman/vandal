...
var key = '__VANDAL__HIST__LOGGING__ENABLED';

function onLoad() {
  document.getElementById('is-log-enabled').addEventListener('click', handleToggleLog);
...
function setLogEnabled(isLogEnabled) {
  chrome.storage.sync.set((0, _defineProperty3.default)({}, key, isLogEnabled), function () {});
}
...
(function () {
  ...
  reactHotLoader.register(key, 'key', '/Users/viven/Opensource/vandal/source/options.js');
  reactHotLoader.register(onLoad, 'onLoad', '/Users/viven/Opensource/vandal/source/options.js');
  reactHotLoader.register(handleSave, 'handleSave', '/Users/viven/Opensource/vandal/source/options.js');
  reactHotLoader.register(setLogEnabled, 'setLogEnabled', '/Users/viven/Opensource/vandal/source/options.js');
  reactHotLoader.register(handleToggleLog, 'handleToggleLog', '/Users/viven/Opensource/vandal/source/options.js');
  leaveModule(module);
})();
